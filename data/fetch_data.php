    ...
    case 'getposts': // POST PUBLIC
        ...
        //    get_something("posts","*","WHERE userid = ".$id." ORDER BY postid DESC ","fetchAll");
                ...
                <?php foreach ($posts as $post) { ?>
                    <div class="postshow card border-0"> 
                        <div class="avatar">
                            <?php echo empty($post['avatar']) ? '<img class="img-fiuld rounded-circle" src="./layout/images/icons/011.png" alt="">' : '<img class="img-fiuld rounded-circle" src="./u/uplaods/avatar/'.$post['avatar'].'" alt="">' ?>
                            <h2 class="py-1"><?php echo $post['titlename'] . ">" ?><?php echo $post['pagename'] ?></h2>
                            <!-- <span class="timespan"><?php echo $post['datetime'] ?></span> -->
                            <!-- <input class="postid" type="hidden" value=""> -->
                            <i class="fas fa-ellipsis-h"></i>
                        </div>
